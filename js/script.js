...
function search() {
    ...
    $.get(
        "https://www.googleapis.com/youtube/v3/search", {
            ...
            q: q,
            type: "video",
            key: "AIzaSyCDBHPVHBDWavIQD64hdR97J09isEICHXg"},
            function(data) {
...
function getOutput(item) {
    ...
    "<h3><a href='https://www.youtube.com/embed/"+videoId+"' data-featherlight='iframe' data-featherlight-iframe-style='display:block;border:none;height:85vh;width:85vw;'>" +title+ "</a></h3>" +
